...
<body class="antialiased sans-serif bg-gray-300">
    <!-- Alert Box -->
    <div class="fixed w-full z-50 flex inset-0 items-start justify-center pointer-events-none md:mt-5"
        x-data="{
            message: '',
        ...
        <template x-if="message">
            <div role="alert" x-transition:enter="transition ease-out duration-300 transform"
                ...
                class="px-4 py-4 w-full md:max-w-sm bg-gray-900 md:rounded-lg shadow-lg">
    ...
    <div x-data="app()" x-init="getTasks()" x-cloak class="flex flex-col min-h-screen border-t-8"
            ...
            <div class="container mx-auto px-4 py-4 -mt-40">
                ...
                <div x-show="!localStorage.getItem('TG-username')">
                    ...
                    <div class="bg-white rounded-lg p-6 md:p-10 md:max-w-md mx-auto shadow-md">
                        ...
                        <input
                            ...
                            type="text" x-model="username" placeholder="Enter your name and hit enter..."
                            @keydown.enter="if (username == '') { return; } localStorage.setItem('TG-username', username); username = ''">
                    </div>
                </div>
                ...
                <div x-show.immediate="showSettingsPage == true">
                    <div x-show.transition="showSettingsPage == true">
                        ...
                        <div class="mb-8">
                            <a href="#" @click.prevent="showSettingsPage = false"
                                class="rounded-lg text-sm px-3 py-2 inline-flex"
                                :class="`text-${colorSelected.value}-500 bg-${colorSelected.value}-800 hover:bg-${colorSelected.value}-700`">&larr;
                                Go Back</a>
                        </div>
                        ...
                        <div class="p-6 bg-white rounded-lg shadow-md md:max-w-4xl" style="min-height: 150px">
                            ...
                            <div class="mb-5">
                                ...
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full md:w-64 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                                    type="text" x-model="username" placeholder="Enter your name">
                            </div>
                                ...
                                <div class="flex items-center">
                                    <div>
                                        <label for="colorSelected"
                                            class="text-gray-800 block font-bold mb-1 text-sm">Select a theme</label>
                                                    ...
                                                    <div class="px-2">
                                                        <template x-if="colorSelected.value === color.value">
                                                            <div class="w-8 h-8 inline-flex rounded-full cursor-pointer border-4 border-white"
                                                                :style="`background: ${color.label}; box-shadow: 0 0 0 2px rgba(0, 0, 0, 0.2);`">
                                                            </div>
                                                        </template>
                            ...
                            <div class="mb-5">
                                <label class="text-gray-800 block mb-1 font-bold text-sm">Banner image <small
                                        class="text-gray-500 text-xs">(optional)</small></label>
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full md:w-1/2 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                                    type="url" x-model="bannerImage"
                                    placeholder="eg. https://picsum.photos/1200/400?random=2">
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="flex">
                                    <label
                                        class="flex justify-start items-center text-truncate rounded-lg bg-gray-200 pl-4 pr-6 py-2 shadow-xs mr-4">
                                        <div class="mr-3" :class="`text-${colorSelected.value}-600`">
                                            <input type="radio" x-model="dateDisplay" value="toDateString"
                                    ...
                                    <label
                                        class="flex justify-start items-center text-truncate rounded-lg bg-gray-200 pl-4 pr-6 py-2 shadow-xs mr-4">
                                        <div class="mr-3" :class="`text-${colorSelected.value}-600`">
                                            <input type="radio" x-model="dateDisplay" value="toLocaleDateString"
                                                class="form-radio focus:outline-none focus:shadow-outline" />
                                        </div>
                            ...
                            <div class="mt-8">
                                <button type="button"
                                    class="bg-white hover:bg-gray-100 text-gray-700 font-semibold py-2 px-4 border border-gray-300 rounded-lg shadow-xs mr-2"
                                    @click="showSettingsPage = false">
                                    Cancel
                                </button>
                                <button type="button" @click="saveSettings"
                                    class="text-white font-semibold py-2 px-4 border border-transparent rounded-lg shadow-xs"
                    ...
                    <div x-show.transition="localStorage.getItem('TG-username') && showSettingsPage == false">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            <div>
                                ...
                                <div x-text="formatDateDisplay(new Date())" class="text-sm"
                                    :class="`text-${colorSelected.value}-400`"></div>
                            </div>
                            <div>
                                <a @click.prevent="showSettingsPage = !showSettingsPage" href="#"
                                    class="rounded-lg px-3 py-2 font-medium inline-flex items-center"
                                                    ...
                                                    <template
                                                        ...
                                                        <div :id="t.uuid">
                                                            ...
                                                            <div x-show="t.edit == true"
                                                                ...
                                                                <div class="mb-4">
                                                                    <label
                                                                        class="text-gray-800 block mb-1 font-bold text-sm">Task
                                                                        Name</label>
                                                                    <input :x-ref="t.uuid"
                                                                        ...
                                                                        type="text" x-model="t.name"
                                                                        @keydown.enter="saveEditTask(t)">
                                                                </div>
                                                                <div class="text-right">
                                                                    ...
                                                                    <button type="button"
                                                                        class="text-white font-semibold py-1 px-2 text-sm border border-transparent rounded-lg shadow-sm"
        ...
        <div class="container mx-auto px-4 py-10">
            <p class="text-gray-600 text-center">Tasksgram - a simple kanban board with <a
                    href="https://tailwindcss.com/"
                    :class="`text-${colorSelected.value}-500 hover:text-${colorSelected.value}-600`"
                    class="underline">TailwindCSS</a> and <a href="https://github.com/alpinejs/alpine/"
                    :class="`text-${colorSelected.value}-500 hover:text-${colorSelected.value}-600`"
                    class="underline">AlpineJS</a>. Made with <span class="text-red-500"><svg
                        class="inline-block h-4 w-4 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
                            d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z"
                            clip-rule="evenodd" />
                    </svg></span> by <a class="underline"
                    :class="`text-${colorSelected.value}-500 hover:text-${colorSelected.value}-600`"
                    href="https://twitter.com/mithicher">@mithicher</a>.</p>
        </div>
        <!-- /Footer -->
        ...
        <div class="fixed inset-0 flex h-screen w-full items-end md:items-center justify-center z-10"
            ...
            <div class="md:p-4 md:max-w-lg mx-auto w-full flex-1 relative overflow-hidden">
                ...
                <div class="w-full rounded-t-lg md:rounded-lg bg-white p-8">
                    <h2 class="font-bold text-2xl mb-6 text-gray-800">Task Details for <span
                            class="leading-normal border-b-2"
                            :class="`text-${colorSelected.value}-600 border-${colorSelected.value}-200`"
                            x-text="task.boardName"></span></h2>

                    <div class="mb-4">
                        <label class="text-gray-800 block mb-1 font-bold text-sm">Task Name</label>
                        <input
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                            type="text" x-model="task.name" x-ref="taskName" autofocus
